...
echo "🚀 INICIANDO O RESET NUCLEAR (SEM SOBREVIVENTES)..."

# 1. MATAR O QUE TRAVA O RESOURCE GROUP
...
# 3. PURGE GLOBAL (O CORAÇÃO DO PROBLEMA)
echo "🧹 Esvaziando a lixeira da Azure (Cognitive Services)..."
# Listamos todos os deletados na subscrição inteira
...
echo "🔍 Esvaziando a lixeira do AI Search..."
...
# 4. DELETAR OS GRUPOS NA FORÇA BRUTA
...
# 5. LIMPEZA DE IDENTIDADES (IMPORTANTE)
